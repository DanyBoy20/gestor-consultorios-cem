    ...
    public function ver(){
        if(!isset($_POST['idconsultorio']) || $_POST['idconsultorio'] == ""){
            ...
            if(!empty($servicioClientes->errores)){
                ...
                /* $datosprestamos = $cliente->datosPrestamosExpedienteCliente($servicioClientes->idcliente); */
                /* ClientesServicios::mostrarExpedienteCliente($datoscliente, $datossolicitudes, $datosprestamos); */                
