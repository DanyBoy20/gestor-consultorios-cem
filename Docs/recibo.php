...
class PDF extends TCPDF {
    public function Header(){
        ...
        /* $this->Cell(0,3, '__________________________________________________________________________________________________________________', 0, 1, 'C'); */
...
if(isset($_POST['id'])){
    ...
    // This method has several options, check the source code documentation for more information
    ob_end_clean();
    $pdf->Output('RECIBO' . $cverecibo . '.pdf', 'I');
}